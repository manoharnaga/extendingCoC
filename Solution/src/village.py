    ...
    def generate_map(self):
        ...
        for hut in self.huts:                                           # hut is 2x2
            ...
            map[hut[0]+1][hut[1]+1] = pt.HUT + \
                ":" + str(hut[0]) + ":" + str(hut[1])
        # random building_level => np.random.randint(1,6)      
        for wall in self.walls_top:                                     # wall is 1x1
            wall_obj = bd.Wall(wall, self, np.random.randint(1,6))
        ...
        for cannon in self.cannons:                                     # cannon is 2x2
            cannon_obj = bd.Cannon(cannon, self, np.random.randint(1,6))
        ...
        for wizard_tower in self.wizard_towers:                          # wizard tower is 1X1
            wizard_tower_obj = bd.WizardTower(wizard_tower, self, np.random.randint(1,6))
